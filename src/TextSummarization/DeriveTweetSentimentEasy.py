...
sentiment = sentiment_dict(BASE_DIR+"/data/AFINN-111.txt")
def get_sentiment_affinn(tweet):
...
#                 print sentiment[word]
    ...
    print tweet + " --- "+ str(sent_score)


# if __name__ == '__main__':
#     get_sentiment_affinn("it's so laddish and juvenile , only teenage boys could possibly find it funny .")