...
def Noun_Phrase(data,no_tags):
    
    np_extractor = NPExtractor(data)
    result = np_extractor.extract()
    result = list(set(result))
    result = result[:no_tags]
    st = SummaryTool()
...
#     print no_of_lines
    ...
    sum_dict = {'tags':result,'original_content':data,'total_words':total_words,'total_no_of_sen':no_of_lines,'no_of_para':no_of_paragraphs}
    return sum_dict

def Noun_Phrase_t(data,no_tags):
    ...
    sum_dict = {'tags':result,'total_words':total_words}
    return sum_dict
